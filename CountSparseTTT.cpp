...
int main(int argc, char *argv[])
{
    ...
    //traverseArray(node2hyperedge);
    //traverseSet(hyperedge2node_set);
	...
	//CountAAA( h_triangle, result, InclusionList, HyperEdgeConnectionRefinedInt,  hyperedge2node,  PairTypeInc, PairTypeInt, HyperEdgeConnectionInc, HyperEdgeConnectionInt);
